...
import { EDIT_CARGO, GET_CARGO_INFO, GET_USER_INFO } from '../../lib/api'
...
export default function EditCargo() {
  ...
  const { data, loading } = useQuery(GET_CARGO_INFO, { variables: { id: router.query.id } })
  useEffect(() => {
    const cargo = data?.cargo
    cargo &&
      setForm({
        [FIELDS.AUTHOR_DATABASE_ID]: cargo[FIELDS.AUTHOR_DATABASE_ID] || null,
                  ...
                  <div className="input-list">
                    ...
                    <label>
                      ...
                      <Select
                        ...
                        onChange={handleChangeFormSelect}
                        value={
                          form[FIELDS.TYPE_LOADING] && {
                            label: form[FIELDS.TYPE_LOADING],
                            value: form[FIELDS.TYPE_LOADING],
                          }
                        }
                        options={typeLoading}
